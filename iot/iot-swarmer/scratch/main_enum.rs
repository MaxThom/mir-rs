...
//
//use crate::device::{Swarm, LiveDevice, LiveSensor};
//
//mod device;
//
...
//                live_device.add_sensor(
//                    LiveSensor::new(
//                        sensor.name.clone(),
//                        sensor.hysteresis,
//                        produce_telemetry_generator_factory(
...
//}
//
//fn produce_telemetry_generator_factory(generator: &str, args: HashMap<String, String>) -> TelemetryType {
